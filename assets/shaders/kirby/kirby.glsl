...
void main(void)
{
    ...
    vec2 ot=uv*2.0-1.0;
    ot.y*=u_resolution.y/u_resolution.x;
    ...
    diff=mix(vec3(1.,.05,.1),diff,smoothstep(0.,0.01,d));
    ...
    vec3 col=mix(vec3(.15,0,0),vec3(1),ao)*shad*diff*1.1;
    col+=emit;
